...
const TEMPLATES = [
  ...
  },
  {
    ...
    sampleImage: "/manus-storage/the-blur-hero-v2_053e32e7.webp",
    overlayGradient: "linear-gradient(to bottom, rgba(13,13,26,0.45) 0%, rgba(13,13,26,0.10) 35%, rgba(13,13,26,0.82) 100%)",
